...
class GeneticAlgorithm(HPOptimizationAbstract):
    ...
    def _generate(self, param_list, score_list, iter_num):
        ...
        result_param_list = HPOptimizerUtil.remove_duplicated_params(self.unique_param_dict,
                                                                     result_param_list)
        num_result_params = len(result_param_list)
        self._add_unique_dict(result_param_list)
    ...
    def _mutation(self, param_dict_list, bound_dict_list):
        ...
        for param_dict in param_dict_list[:self._n_mut]:
            temp_param_dict = HPOptimizerUtil.mutate(self._pbounds, param_dict, self._mut_prob)
