...
class ParticleSwarmOptimization_boundary(GeneticAlgorithm, HPOptimizationAbstract):
    def __init__(self, **kwargs):
        # inheritance init
        super(ParticleSwarmOptimization_boundary, self).__init__(**kwargs)
...
if __name__ == '__main__':
    ...
    pso = ParticleSwarmOptimization_boundary(hps_info = hprs_info)
